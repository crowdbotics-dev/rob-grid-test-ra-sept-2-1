...
## Project Structure
    ...
    ├── rob_grid_test_ra_sept_2_1  # Django project configurations
...
1. Clone this repo and `cd rob_grid_test_ra_sept_2_1`
...
2. Clone this repo and `cd rob_grid_test_ra_sept_2_1`
